...
// ====================================================
// get
const url2 = 'https://iti-js-project-backend.vercel.app/api/cart';
fetch(url2, {
    method: 'GET', 
    headers: {
      'Authorization': `Bearer ${token}`,
  ...
  .then(data => {
      ...
      const container = document.getElementById('p-chexk'); 
        console.log(items);
      ...
      items.forEach(item => {
        ...
        <div class="card" >
            ...
            <div class="card-details">
                ...
                <div class="card-price"><span>Price</span>:${item.product.price} </div>
                <div class="card-price"><span>Quantity</span>:${item.quantity} </div>
